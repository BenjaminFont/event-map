...
|-----------|------|--------|
| Event Type Breakdown Chart | [event-type-breakdown-chart.md](event-type-breakdown-chart.md) | Draft |
| Date Range Filter | [date-range-filter.md](date-range-filter.md) | Draft |
| Refactoring Plan | [refactoring-plan.md](refactoring-plan.md) | Draft |
